  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className="flex items-center gap-1.5 rounded-lg border border-[var(--eco-rule)] bg-black/40 px-2.5 py-1.5 text-xs text-[var(--eco-cream)] transition hover:border-[var(--eco-rule)]/80 hover:bg-black/60 shadow-sm"
              ...
              <button
                ...
                className={`flex w-full items-center justify-between rounded-lg px-2.5 py-1.5 text-left text-xs transition ${
                  currentLanguage === lang.code
                    ...
                    : 'text-[var(--eco-cream)]/90 hover:bg-white/5'
                }`}
              >
                ...
                {currentLanguage === lang.code && <span className="text-amber-400">✓</span>}
              </button>
            ))}
          </div>
        </>
