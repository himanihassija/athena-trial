        ...
        <div className="p-5">
          {bookedSlot ? (
            <div className="text-center py-6 space-y-4">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-emerald-500/20 text-2xl text-emerald-300 ring-1 ring-emerald-500/40">
                ✓
              </div>
              ...
              <div className="flex items-center justify-center gap-3 pt-2">
                <button
                  ...
                  className="rounded-lg bg-amber-500/20 px-4 py-2 text-xs font-semibold text-amber-200 ring-1 ring-amber-400/40 hover:bg-amber-500/30"
                >
                  📥 Add to Calendar (.ics)
                </button>
                <button
            ...
            <form onSubmit={handleBook} className="space-y-4">
                        ...
                        <button
                          ...
                          className={`rounded-lg border p-2.5 text-left text-xs transition ${
                            isBooked
                              ...
                              : isSelected
                              ? 'border-amber-400 bg-amber-500/20 text-amber-200 ring-1 ring-amber-400 font-semibold'
                              : 'border-[var(--eco-rule)] bg-black/30 text-[var(--eco-cream)]/90 hover:border-[var(--eco-rule)]/80'
                          }`}
                        >
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled
                    value={studentName}
                    className="mt-1 w-full rounded-lg border border-[var(--eco-rule)]/50 bg-black/20 px-3 py-2 text-xs text-[var(--eco-cream-faint)]"
                  />
                </div>
              </div>
              ...
              <div className="mt-5 flex items-center justify-end gap-2 border-t border-[var(--eco-rule)]/40 pt-3">
                ...
                <button
                  ...
                  className="rounded-lg bg-amber-500 px-4 py-2 text-xs font-semibold text-black hover:bg-amber-400 disabled:opacity-50 transition"
                >
