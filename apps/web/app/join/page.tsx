...
export default function JoinPage() {
  ...
  // The redesign dropped the "Preferred language" input, so nothing sets this
  // any more and `preferredLanguage` always goes up undefined. Kept as a
  // read-only placeholder rather than ripped out, since the field is still
  // part of the join contract server-side.
